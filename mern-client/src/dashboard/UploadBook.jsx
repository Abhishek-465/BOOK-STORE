...
const UploadBook = () => {
  ...
  const handleBookSubmit =(event)=>{
    ...
    fetch("https://book-store-mqzx.onrender.com/upload-book",{
      method: "POST",
      headers: {
  ...
  return (
    ...
    <div className='lg:w-3/4 '>
        ...
        <Textarea id="bookDescription" type="text" placeholder="Book Description" className='w-full' name="bookDescription" required rows={4} />
      </div>
      ...
      <Button type="submit" className='mt-5 w-3/4'>Upload</Button>
